 ...
 * @param {CollectionCondition} [collection.condition={}] - Collection conditions
 */
'use strict'
...
class Collection {
  constructor (collection = {}) {
    ...
    let { entities = [], meta = {}, condition = {} } = collection
    const s = this
    Object.assign(s, { entities, meta, condition })
  }
 ...
 * @typedef {Object} CollectionCondition
